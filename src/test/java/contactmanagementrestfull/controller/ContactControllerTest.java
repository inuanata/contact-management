...
class ContactControllerTest {
    ...
    void createContactSuccess() throws Exception {
        CreateContactRequest request = new CreateContactRequest();
        request.setFirstName("bangik");
        request.setLastName("bangiks");
        request.setEmail("bangik@example.com");
        ...
        mockMvc.perform(
            ...
            assertEquals("bangik", response.getData().getFirstName());
            assertEquals("bangiks", response.getData().getLastName());
            assertEquals("bangik@example.com", response.getData().getEmail());
